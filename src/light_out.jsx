    ...
    <div class="Gallry_section">
      <div class="app">
        <div class="image_listing">
          {
            images.map((ele,idx) => {
              return <div class="img" onClick={ADD}>
                <img id={idx}   src={ele.image_url} />
              </div>
            })
          }
        </div>
        { idx!=null &&<Modal id={idx} setidx={setidx}  max={images.length} images={images}/>}
      </div>
    </div>
  )
}
export default Light_out